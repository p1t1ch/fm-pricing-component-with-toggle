const config = {
  ...
  shortTitle: 'FM Pricing component with toggle',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Pricing component with toggle" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-pricing-component-with-toggle.netlify.app',
